...
<body>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
      ...
      <a class="navbar-brand" href="/">Página Vulnerable</a>
    ...
    <div class="container ccontainer" id="Home">
      <h1 class="text-center display-3 text-dark mb-3 mt-3">Comparte tu <b>visión</b> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px">
      ...
      <p class="text-center display-text">¡Bienvenido! En Página Vulnerable hemos organizado un concurso. Cada imágen mensual contiene una clave secreta escondida mediante técnicas de esteganografía. Si la encuentras y aciertas entrarás a formar parte del sorteo de un nuevo setup gaming personalizado</p>
      <h1 class="my-3 ">Introduce la clave de este mes</h1>
      <form action="/reflected" method="post" class=" d-flex justify-content-center align-items-center p-3">
        <input type="text" name="clave" rows="10" class="form-control-lg text-center m-3" placeholder="Clave secreta"></input>
