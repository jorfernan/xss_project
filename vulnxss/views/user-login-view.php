...
<body>
  ...
  <body>
    ...
    <form action="<?php $_SERVER['PHP_SELF']?>/acceso" method="post" class="d-flex flex-column" autocomplete="off">
        <input type="text" name="logindata[name]" placeholder="Nombre" class="form-control-lg mt-5 mb-2 text-center rounded rounded-pill">
        <input type="password" name="logindata[passwd]" placeholder="Contraseña" class="form-control-lg my-1 text-center rounded rounded-pill">
